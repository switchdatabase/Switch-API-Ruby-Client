...
module SwaggerClient
  ...
  class Body
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'whereType')
        self.where_type = attributes[:'whereType']
      end

      if attributes.has_key?(:'where')
        if (value = attributes[:'where']).is_a?(Array)
          self.where = value
        end
      end
    ...
    def hash
      [list, count, page, where_type, where, order].hash
    end
